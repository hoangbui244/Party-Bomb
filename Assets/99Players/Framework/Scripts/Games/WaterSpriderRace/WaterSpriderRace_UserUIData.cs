...
using TMPro;
using UnityEngine;
public class WaterSpriderRace_UserUIData : MonoBehaviour
{
	[Serializable]
	...
	private void SetPlayerIcon()
	{
		if (!(playerIconSp == null))
		{
			switch (userType)
			{
			case WaterSpriderRace_Define.UserType.PLAYER_1:

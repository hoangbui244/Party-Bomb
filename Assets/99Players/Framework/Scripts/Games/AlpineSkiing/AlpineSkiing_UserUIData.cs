...
using TMPro;
using UnityEngine;
public class AlpineSkiing_UserUIData : MonoBehaviour {
    [Serializable]
    ...
    private void SetPlayerIcon() {
        if (!(playerIconSp == null)) {
            switch (userType) {
                case AlpineSkiing_Define.UserType.PLAYER_1:

using GamepadInput;
using UnityEngine;
public class AlpineSkiing_ControllerManager : SingletonCustom<AlpineSkiing_ControllerManager> {
    ...
    public bool IsPushButton_A(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_A(_userType, _buttonPushType);
    }
    public bool IsPushButton_B(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_B(_userType, _buttonPushType);
    }
    public bool IsPushButton_X(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_X(_userType, _buttonPushType);
    }
    public bool IsPushButton_Y(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_Y(_userType, _buttonPushType);
    }
    public bool IsPushButton_L(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_L(_userType, _buttonPushType);
    }
    public bool IsPushButton_ZL(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_ZL(_userType, _buttonPushType);
    }
    public bool IsPushButton_R(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_R(_userType, _buttonPushType);
    }
    public bool IsPushButton_ZR(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_ZR(_userType, _buttonPushType);
    }
    public bool IsPushCrossKey(AlpineSkiing_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _buttonPushType) {
    ...
    public bool IsStickTiltDirection(AlpineSkiing_Define.UserType _userType, StickType _stickType, StickDirType _stickDirType, float _stickNeutralValue = 0.5f) {
    ...
    public bool IsPushButton_StickR(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_StickR(_userType, _buttonPushType);
    }
    public bool IsPushButton_StickL(AlpineSkiing_Define.UserType _userType, ButtonPushType _buttonPushType) {
        return ProcessPushButton_StickL(_userType, _buttonPushType);
    }
    public bool IsStickTilt(AlpineSkiing_Define.UserType _userType, StickType _stickType) {
        return GetStickTilt(_userType, _stickType) > 0.01f;
    }
    private bool ProcessPushButton_A(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
    ...
    private bool ProcessPushButton_B(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_X(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_Y(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_L(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_ZL(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_R(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_ZR(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    public Vector3 GetStickDir_R(AlpineSkiing_Define.UserType _userType) {
        float num = 0f;
        float num2 = 0f;
    ...
    public Vector3 GetStickDir_L(AlpineSkiing_Define.UserType _userType) {
        float num = 0f;
        float num2 = 0f;
        Vector3 mVector3Zero = CalcManager.mVector3Zero;
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
    ...
    private bool ProcessPushButton_StickR(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    private bool ProcessPushButton_StickL(AlpineSkiing_Define.UserType _userType, ButtonPushType _type) {
        int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : AlpineSkiing_Define.UserType.PLAYER_1);
        switch (_type) {
            case ButtonPushType.DOWN:
    ...
    public float GetStickTilt(AlpineSkiing_Define.UserType _userType, StickType _stickType) {
        if (_stickType == StickType.L) {
            return GetStickDir_L(_userType).magnitude;
        }
        return GetStickDir_R(_userType).magnitude;
    }
    private bool ProcessCrossKey(AlpineSkiing_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _type) {
    ...
    private void ContinueInputHold_Stick_L(AlpineSkiing_Define.UserType _userType) {
        intervalInputHold_LStick[(int)_userType] = 0.2f;
    }
    private void ContinueInputHold_Stick_R(AlpineSkiing_Define.UserType _userType) {
        intervalInputHold_RStick[(int)_userType] = 0.2f;
    }
    private void ContinueInputHold_CrossKey(AlpineSkiing_Define.UserType _userType) {
        intervalInputHold_CrossKey[(int)_userType] = 0.2f;
    }
    private void ResetInputHold_Stick_L(AlpineSkiing_Define.UserType _userType) {
        intervalInputHold_LStick[(int)_userType] = 0f;
    }
    private void ResetInputHold_Stick_R(AlpineSkiing_Define.UserType _userType) {
        intervalInputHold_RStick[(int)_userType] = 0f;
    }
    private bool IsReturnInputHold_Stick_L(AlpineSkiing_Define.UserType _userType) {
        return intervalInputHold_LStick[(int)_userType] <= 0f;
    }
    private bool IsReturnInputHold_Stick_R(AlpineSkiing_Define.UserType _userType) {
        return intervalInputHold_RStick[(int)_userType] <= 0f;
    }
    private bool IsReturnInputHold_CrossKey(AlpineSkiing_Define.UserType _userType) {

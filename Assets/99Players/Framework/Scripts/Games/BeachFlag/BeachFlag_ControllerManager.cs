using GamepadInput;
using UnityEngine;
public class BeachFlag_ControllerManager : SingletonCustom<BeachFlag_ControllerManager>
{
	...
	public bool IsPushButton_A(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_A(_userType, _buttonPushType);
	}
	public bool IsPushButton_B(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_B(_userType, _buttonPushType);
	}
	public bool IsPushButton_X(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_X(_userType, _buttonPushType);
	}
	public bool IsPushButton_Y(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_Y(_userType, _buttonPushType);
	}
	public bool IsPushButton_L(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_L(_userType, _buttonPushType);
	}
	public bool IsPushButton_ZL(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_ZL(_userType, _buttonPushType);
	}
	public bool IsPushButton_R(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_R(_userType, _buttonPushType);
	}
	public bool IsPushButton_ZR(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_ZR(_userType, _buttonPushType);
	}
	public bool IsPushCrossKey(BeachFlag_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _buttonPushType)
	{
	...
	public bool IsStickTiltDirection(BeachFlag_Define.UserType _userType, StickType _stickType, StickDirType _stickDirType, float _stickNeutralValue = 0.5f)
	{
	...
	public bool IsPushButton_StickR(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickR(_userType, _buttonPushType);
	}
	public bool IsPushButton_StickL(BeachFlag_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickL(_userType, _buttonPushType);
	}
	public bool IsStickTilt(BeachFlag_Define.UserType _userType, StickType _stickType)
	{
		return GetStickTilt(_userType, _stickType) > 0.01f;
	}
	private bool ProcessPushButton_A(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_B(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_X(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_Y(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_L(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_ZL(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_R(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_ZR(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public Vector3 GetStickDir_R(BeachFlag_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
	...
	public Vector3 GetStickDir_L(BeachFlag_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
		Vector3 mVector3Zero = CalcManager.mVector3Zero;
	...
	private bool ProcessPushButton_StickR(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_StickL(BeachFlag_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : BeachFlag_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public float GetStickTilt(BeachFlag_Define.UserType _userType, StickType _stickType)
	{
	...
	private bool ProcessCrossKey(BeachFlag_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _type)
	{
	...
	private void ContinueInputHold_Stick_L(BeachFlag_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_Stick_R(BeachFlag_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_CrossKey(BeachFlag_Define.UserType _userType)
	{
		intervalInputHold_CrossKey[(int)_userType] = 0.2f;
	}
	private void ResetInputHold_Stick_L(BeachFlag_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0f;
	}
	private void ResetInputHold_Stick_R(BeachFlag_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0f;
	}
	private bool IsReturnInputHold_Stick_L(BeachFlag_Define.UserType _userType)
	{
		return intervalInputHold_LStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_Stick_R(BeachFlag_Define.UserType _userType)
	{
		return intervalInputHold_RStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_CrossKey(BeachFlag_Define.UserType _userType)
	{

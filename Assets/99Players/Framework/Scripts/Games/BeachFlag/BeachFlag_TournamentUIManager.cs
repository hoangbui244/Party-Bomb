...
using UnityEngine;
public class BeachFlag_TournamentUIManager : MonoBehaviour
{
	...
	private BeachFlag_GameManager.TeamData[] prevLoserBattleTeamData = new BeachFlag_GameManager.TeamData[2];
	...
	public void SetTeamData(string _vsTeamNoStr, RoundType _setRoundType)
	{
		...
		case RoundType.Round_1st:
		{
			...
			int num = SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[0].teamNo).memberPlayerNoList[0];
			if ((uint)num <= 3u)
			{
				...
				{
					teamNameSprites[0].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[0].teamNo).memberPlayerNoList[0] + 1).ToString() + "p");
			...
			{
				teamNameSprites[0].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[0].teamNo).memberPlayerNoList[0] - 3).ToString());
				teamNameSprites[0].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[0].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[0].teamNo).memberPlayerNoList[0]]];
			arrayTeamNo[0] = teamData_1stRound[0].teamNo;
			num = SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[1].teamNo).memberPlayerNoList[0];
			if ((uint)num <= 3u)
			{
				if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 1)
				{
				...
				{
					teamNameSprites[1].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[1].teamNo).memberPlayerNoList[0] + 1).ToString() + "p");
			...
			{
				teamNameSprites[1].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[1].teamNo).memberPlayerNoList[0] - 3).ToString());
				teamNameSprites[1].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[1].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[1].teamNo).memberPlayerNoList[0]]];
		...
		case RoundType.Round_2nd:
		{
			...
			int num = SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[0].teamNo).memberPlayerNoList[0];
			if ((uint)num <= 3u)
			{
				if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 1)
				{
				...
				{
					teamNameSprites[2].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[0].teamNo).memberPlayerNoList[0] + 1).ToString() + "p");
			...
			{
				teamNameSprites[2].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[0].teamNo).memberPlayerNoList[0] - 3).ToString());
				teamNameSprites[2].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[2].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[0].teamNo).memberPlayerNoList[0]]];
			arrayTeamNo[2] = teamData_2ndRound[0].teamNo;
			num = SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[1].teamNo).memberPlayerNoList[0];
			if ((uint)num <= 3u)
			{
				if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 1)
				{
				...
				{
					teamNameSprites[3].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[1].teamNo).memberPlayerNoList[0] + 1).ToString() + "p");
			...
			{
				teamNameSprites[3].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[1].teamNo).memberPlayerNoList[0] - 3).ToString());
				teamNameSprites[3].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[3].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[1].teamNo).memberPlayerNoList[0]]];
	...
	private IEnumerator LineAnimation(bool _isWinnerTeamIsLeft)
	{
		...
		case RoundType.Round_1st:
			if (_isWinnerTeamIsLeft)
			{
				...
				arrayTeamCharacter[0].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[0].teamNo).memberPlayerNoList[0]]];
				arrayTeamCharacter[1].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[1].teamNo).memberPlayerNoList[0]]];
			}
			else
			{
				...
				UnityEngine.Debug.Log("【決勝進出】:" + teamData_Final[0].teamNo.ToString());
				arrayTeamCharacter[0].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[0].teamNo).memberPlayerNoList[0]]];
				arrayTeamCharacter[1].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_1stRound[1].teamNo).memberPlayerNoList[0]]];
			}
			break;
		case RoundType.Round_2nd:
			if (_isWinnerTeamIsLeft)
			{
				...
				arrayTeamCharacter[2].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[0].teamNo).memberPlayerNoList[0]]];
				arrayTeamCharacter[3].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[1].teamNo).memberPlayerNoList[0]]];
			}
			else
			{
				teamData_LoserBattle[1] = teamData_2ndRound[0];
				teamData_Final[1] = teamData_2ndRound[1];
				arrayTeamCharacter[2].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[0].teamNo).memberPlayerNoList[0]]];
				arrayTeamCharacter[3].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(teamData_2ndRound[1].teamNo).memberPlayerNoList[0]]];
			}
			break;
		case RoundType.LoserBattle:
			if (_isWinnerTeamIsLeft)
			{
				arrayTeamCharacter[GetTeamNoToIdx(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide).teamNo)].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide).teamNo).memberPlayerNoList[0]]];
				arrayTeamCharacter[GetTeamNoToIdx(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo)].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo).memberPlayerNoList[0]]];
			}
			else
			{
				arrayTeamCharacter[GetTeamNoToIdx(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo)].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo).memberPlayerNoList[0]]];
		...
		case RoundType.Round_Final:
			...
			{
				arrayTeamCharacter[GetTeamNoToIdx(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide).teamNo)].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide).teamNo).memberPlayerNoList[0]]];
				arrayTeamCharacter[GetTeamNoToIdx(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo)].sprite = arrayCharacterGood[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo).memberPlayerNoList[0]]];
			}
			else
			{
				arrayTeamCharacter[GetTeamNoToIdx(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo)].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo).memberPlayerNoList[0]]];
		...
		case RoundType.LoserBattle:
			if (_isWinnerTeamIsLeft)
			{
				...
				{
					if (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide).teamNo == teamData_LoserBattle[k].teamNo)
					{
			...
			else
			{
				...
				{
					if (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo == teamData_LoserBattle[l].teamNo)
					{
		...
		case RoundType.Round_Final:
			...
			if (_isWinnerTeamIsLeft)
			{
				...
				{
					if (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide).teamNo == teamData_Final[i].teamNo)
					{
			...
			else
			{
				...
				{
					if (SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide).teamNo == teamData_Final[j].teamNo)
					{
		...
		else
		{
			...
			if (currentRoundType == RoundType.Round_Final)
			{
				LeanTween.moveLocalY(tableUIAnchor.gameObject, 1560f, 0.5f).setEaseInBack().setOnComplete((Action)delegate
				{
					if (_isWinnerTeamIsLeft)
					{
						arrayTeamCharacter[GetTeamNoToIdx(prevLoserBattleTeamData[0].teamNo)].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(prevLoserBattleTeamData[0].teamNo).memberPlayerNoList[0]]];
						arrayTeamCharacter[GetTeamNoToIdx(prevLoserBattleTeamData[1].teamNo)].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(prevLoserBattleTeamData[1].teamNo).memberPlayerNoList[0]]];
					}
					else
					{
						arrayTeamCharacter[GetTeamNoToIdx(prevLoserBattleTeamData[1].teamNo)].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(prevLoserBattleTeamData[1].teamNo).memberPlayerNoList[0]]];
						arrayTeamCharacter[GetTeamNoToIdx(prevLoserBattleTeamData[0].teamNo)].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(prevLoserBattleTeamData[0].teamNo).memberPlayerNoList[0]]];
					}
				});
			}
			else
		...
		{
			prevLoserBattleTeamData[0] = SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.LeftSide);
			prevLoserBattleTeamData[1] = SingletonCustom<BeachFlag_GameManager>.Instance.GetTeamData(BeachFlag_GameManager.PositionSideType.RightSide);
		}
	}

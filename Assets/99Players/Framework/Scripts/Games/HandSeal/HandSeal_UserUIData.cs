...
using TMPro;
using UnityEngine;
public class HandSeal_UserUIData : MonoBehaviour
{
	[Serializable]
	...
	private void SetPlayerIcon()
	{
		if (!(playerIconSp == null))
		{
			switch (userType)
			{
			case HandSeal_Define.UserType.PLAYER_1:

...
using UnityEngine;
public class SpearBattle_TournamentUIManager : MonoBehaviour
{
	...
	public void Init()
	{
		...
		tableBackFade.gameObject.SetActive(value: false);
	...
	public void SetTeamData(string _vsTeamNoStr, RoundType _setRoundType)
	{
		...
		case RoundType.Round_1st:
		{
			...
			int playerNo3 = SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).leftCharaData.playerNo;
			if ((uint)playerNo3 <= 3u)
			{
				...
				{
					teamNameSprites[0].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (playerNo3 + 1).ToString() + "p");
			...
			{
				teamNameSprites[0].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (playerNo3 - 3).ToString());
				teamNameSprites[0].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[0].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[playerNo3]];
			arrayTeamNo[0] = teamData_1stRound[0].teamNo;
			int playerNo4 = SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).rightCharaData.playerNo;
			if ((uint)playerNo4 <= 3u)
			{
				if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 1)
				{
				...
				{
					teamNameSprites[1].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (playerNo4 + 1).ToString() + "p");
			...
			{
				teamNameSprites[1].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (playerNo4 - 3).ToString());
				teamNameSprites[1].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[1].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[playerNo4]];
		...
		case RoundType.Round_2nd:
		{
			...
			int playerNo = SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).leftCharaData.playerNo;
			if ((uint)playerNo <= 3u)
			{
				if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 1)
				{
				...
				{
					teamNameSprites[2].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (playerNo + 1).ToString() + "p");
			...
			{
				teamNameSprites[2].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (playerNo - 3).ToString());
				teamNameSprites[2].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[2].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[playerNo]];
			arrayTeamNo[2] = teamData_2ndRound[0].teamNo;
			int playerNo2 = SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).rightCharaData.playerNo;
			if ((uint)playerNo2 <= 3u)
			{
				if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 1)
				{
				...
				{
					teamNameSprites[3].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_" + (playerNo2 + 1).ToString() + "p");
			...
			{
				teamNameSprites[3].sprite = SingletonCustom<SAManager>.Instance.GetSprite(SAType.Common, "_screen_cp" + (playerNo2 - 3).ToString());
				teamNameSprites[3].gameObject.SetActive(value: false);
			}
			arrayTeamCharacter[3].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[playerNo2]];
	...
	private IEnumerator LineAnimation(bool _isWinnerTeamIsLeft)
	{
		...
		{
			arrayTeamCharacter[0].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).leftCharaData.playerNo]];
			arrayTeamCharacter[1].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).rightCharaData.playerNo]];
			arrayTeamCharacter[2].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).leftCharaData.playerNo]];
			arrayTeamCharacter[3].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).rightCharaData.playerNo]];
		}
		...
		case RoundType.Round_1st:
			if (_isWinnerTeamIsLeft)
			{
				...
				arrayTeamCharacter[0].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).leftCharaData.playerNo]];
				arrayTeamCharacter[1].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).rightCharaData.playerNo]];
			}
			else
			{
				...
				UnityEngine.Debug.Log("【決勝進出】:" + teamData_Final[0].teamNo.ToString());
				arrayTeamCharacter[0].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).leftCharaData.playerNo]];
				arrayTeamCharacter[1].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(0).rightCharaData.playerNo]];
			}
			break;
		case RoundType.Round_2nd:
			if (_isWinnerTeamIsLeft)
			{
				...
				arrayTeamCharacter[2].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).leftCharaData.playerNo]];
				arrayTeamCharacter[3].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).rightCharaData.playerNo]];
			}
			else
			{
				teamData_LoserBattle[1] = teamData_2ndRound[0];
				teamData_Final[1] = teamData_2ndRound[1];
				arrayTeamCharacter[2].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).leftCharaData.playerNo]];
				arrayTeamCharacter[3].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(1).rightCharaData.playerNo]];
			}
			break;
		case RoundType.LoserBattle:
			if (_isWinnerTeamIsLeft)
			{
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.tournamentNo].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.playerNo]];
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.tournamentNo].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.playerNo]];
			}
			else
			{
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.tournamentNo].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.playerNo]];
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.tournamentNo].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.playerNo]];
			}
			break;
		case RoundType.Round_Final:
			if (_isWinnerTeamIsLeft)
			{
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).leftCharaData.tournamentNo].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).leftCharaData.playerNo]];
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).rightCharaData.tournamentNo].sprite = arrayCharacterGood[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).rightCharaData.playerNo]];
			}
			else
			{
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).rightCharaData.tournamentNo].sprite = arrayCharacterHappy[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).rightCharaData.playerNo]];
				arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).leftCharaData.tournamentNo].sprite = arrayCharacterGood[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).leftCharaData.playerNo]];
			}
			break;
		}
		yield return new WaitForSeconds(1f);
		LeanTween.moveLocalY(tableUIAnchor.gameObject, def_TableUIPos_Y, 0.5f).setEaseOutBack();
		tableBackFade.gameObject.SetActive(value: true);
		...
		case RoundType.LoserBattle:
			if (_isWinnerTeamIsLeft)
			{
				...
				{
					if (SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.charaNo == teamData_LoserBattle[k].teamNo)
					{
			...
			else
			{
				...
				{
					if (SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.charaNo == teamData_LoserBattle[l].teamNo)
					{
		...
		case RoundType.Round_Final:
			...
			if (_isWinnerTeamIsLeft)
			{
				...
				{
					if (SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).leftCharaData.charaNo == teamData_Final[i].teamNo)
					{
			...
			else
			{
				...
				{
					if (SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(3).rightCharaData.charaNo == teamData_Final[j].teamNo)
					{
		...
		else
		{
			...
			if (currentRoundType == RoundType.Round_Final)
			{
				LeanTween.moveLocalY(tableUIAnchor.gameObject, 1560f, 0.5f).setEaseInBack().setOnComplete((Action)delegate
				{
					if (_isWinnerTeamIsLeft)
					{
						arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.tournamentNo].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.playerNo]];
						arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.tournamentNo].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.playerNo]];
					}
					else
					{
						arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.tournamentNo].sprite = arrayCharacter[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).rightCharaData.playerNo]];
						arrayTeamCharacter[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.tournamentNo].sprite = arrayCharacterSad[SingletonCustom<GameSettingManager>.Instance.ArraySelectChracterIdx[SingletonCustom<SpearBattle_GameManager>.Instance.GetBattleData(2).leftCharaData.playerNo]];
					}
				});
			}

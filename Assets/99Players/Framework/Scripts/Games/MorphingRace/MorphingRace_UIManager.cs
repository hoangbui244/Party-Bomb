using UnityEngine;
public class MorphingRace_UIManager : SingletonCustom<MorphingRace_UIManager>
{
	...
	private MorphingRace_LayoutData[] singleLayoutData;
	[SerializeField]
	[Header("【２人】の時のレイアウトデ\u30fcタ")]
	private MorphingRace_LayoutData[] multiLayoutData_Two;
	[SerializeField]
	[Header("【３人】の時のレイアウトデ\u30fcタ")]
	private MorphingRace_LayoutData[] multiLayoutData_Three;
	[SerializeField]
	[Header("【４人】の時のレイアウトデ\u30fcタ")]
	private MorphingRace_LayoutData[] multiLayoutData_Four;
	public void Init()
	{
		...
		else if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 2)
		{
			...
			for (int j = 0; j < multiLayoutData_Two.Length; j++)
			{
				...
				SetPlayerIcon(j, (int)SingletonCustom<MorphingRace_PlayerManager>.Instance.GetPlayer(j).GetUserType());
		...
		else if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 3)
		{
			...
			for (int k = 0; k < multiLayoutData_Three.Length; k++)
			{
				...
				SetPlayerIcon(k, (int)SingletonCustom<MorphingRace_PlayerManager>.Instance.GetPlayer(k).GetUserType());
		...
		else if (SingletonCustom<GameSettingManager>.Instance.PlayerNum == 4)
		{
			...
			for (int l = 0; l < multiLayoutData_Four.Length; l++)
			{
				...
				SetPlayerIcon(l, (int)SingletonCustom<MorphingRace_PlayerManager>.Instance.GetPlayer(l).GetUserType());

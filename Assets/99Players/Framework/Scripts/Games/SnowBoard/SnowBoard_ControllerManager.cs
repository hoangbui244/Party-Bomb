using GamepadInput;
using UnityEngine;
public class SnowBoard_ControllerManager : SingletonCustom<SnowBoard_ControllerManager>
{
	...
	public bool IsPushButton_A(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_A(_userType, _buttonPushType);
	}
	public bool IsPushButton_B(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_B(_userType, _buttonPushType);
	}
	public bool IsPushButton_X(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_X(_userType, _buttonPushType);
	}
	public bool IsPushButton_Y(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_Y(_userType, _buttonPushType);
	}
	public bool IsPushButton_L(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_L(_userType, _buttonPushType);
	}
	public bool IsPushButton_ZL(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_ZL(_userType, _buttonPushType);
	}
	public bool IsPushButton_R(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_R(_userType, _buttonPushType);
	}
	public bool IsPushButton_ZR(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_ZR(_userType, _buttonPushType);
	}
	public bool IsPushCrossKey(SnowBoard_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _buttonPushType)
	{
	...
	public bool IsStickTiltDirection(SnowBoard_Define.UserType _userType, StickType _stickType, StickDirType _stickDirType, float _stickNeutralValue = 0.5f)
	{
	...
	public bool IsPushButton_StickR(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickR(_userType, _buttonPushType);
	}
	public bool IsPushButton_StickL(SnowBoard_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickL(_userType, _buttonPushType);
	}
	public bool IsStickTilt(SnowBoard_Define.UserType _userType, StickType _stickType)
	{
		return GetStickTilt(_userType, _stickType) > 0.01f;
	}
	private bool ProcessPushButton_A(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_B(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_X(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_Y(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_L(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_ZL(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_R(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_ZR(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public Vector3 GetStickDir_R(SnowBoard_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
	...
	public Vector3 GetStickDir_L(SnowBoard_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
		Vector3 mVector3Zero = CalcManager.mVector3Zero;
	...
	private bool ProcessPushButton_StickR(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_StickL(SnowBoard_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : SnowBoard_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public float GetStickTilt(SnowBoard_Define.UserType _userType, StickType _stickType)
	{
	...
	private bool ProcessCrossKey(SnowBoard_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _type)
	{
	...
	private void ContinueInputHold_Stick_L(SnowBoard_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_Stick_R(SnowBoard_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_CrossKey(SnowBoard_Define.UserType _userType)
	{
		intervalInputHold_CrossKey[(int)_userType] = 0.2f;
	}
	private void ResetInputHold_Stick_L(SnowBoard_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0f;
	}
	private void ResetInputHold_Stick_R(SnowBoard_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0f;
	}
	private bool IsReturnInputHold_Stick_L(SnowBoard_Define.UserType _userType)
	{
		return intervalInputHold_LStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_Stick_R(SnowBoard_Define.UserType _userType)
	{
		return intervalInputHold_RStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_CrossKey(SnowBoard_Define.UserType _userType)
	{

using GamepadInput;
using UnityEngine;
public class Takoyaki_ControllerManager : SingletonCustom<Takoyaki_ControllerManager>
{
	...
	public bool IsPushButton_A(Takoyaki_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_A(_userType, _buttonPushType);
	}
	public bool IsPushButton_X(Takoyaki_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_X(_userType, _buttonPushType);
	}
	public bool IsPushButton_Y(Takoyaki_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_Y(_userType, _buttonPushType);
	}
	public bool IsPushCrossKey(Takoyaki_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _buttonPushType)
	{
	...
	public bool IsStickTiltDirection(Takoyaki_Define.UserType _userType, StickType _stickType, StickDirType _stickDirType, float _stickNeutralValue = 0.5f)
	{
	...
	public bool IsPushButton_StickR(Takoyaki_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickR(_userType, _buttonPushType);
	}
	public bool IsPushButton_StickL(Takoyaki_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickL(_userType, _buttonPushType);
	}
	public bool IsStickTilt(Takoyaki_Define.UserType _userType, StickType _stickType)
	{
		return GetStickTilt(_userType, _stickType) > 0.01f;
	}
	private bool ProcessPushButton_A(Takoyaki_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : Takoyaki_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_X(Takoyaki_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : Takoyaki_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_Y(Takoyaki_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : Takoyaki_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public Vector3 GetStickDir_R(Takoyaki_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
	...
	public Vector3 GetStickDir_L(Takoyaki_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
		Vector3 mVector3Zero = CalcManager.mVector3Zero;
	...
	private bool ProcessPushButton_StickR(Takoyaki_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : Takoyaki_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_StickL(Takoyaki_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : Takoyaki_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public float GetStickTilt(Takoyaki_Define.UserType _userType, StickType _stickType)
	{
	...
	private bool ProcessCrossKey(Takoyaki_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _type)
	{
	...
	private void ContinueInputHold_Stick_L(Takoyaki_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_Stick_R(Takoyaki_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_CrossKey(Takoyaki_Define.UserType _userType)
	{
		intervalInputHold_CrossKey[(int)_userType] = 0.2f;
	}
	private void ResetInputHold_Stick_L(Takoyaki_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0f;
	}
	private void ResetInputHold_Stick_R(Takoyaki_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0f;
	}
	private bool IsReturnInputHold_Stick_L(Takoyaki_Define.UserType _userType)
	{
		return intervalInputHold_LStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_Stick_R(Takoyaki_Define.UserType _userType)
	{
		return intervalInputHold_RStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_CrossKey(Takoyaki_Define.UserType _userType)
	{

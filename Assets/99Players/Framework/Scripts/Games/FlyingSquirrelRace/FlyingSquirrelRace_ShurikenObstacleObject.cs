...
public class FlyingSquirrelRace_ShurikenObstacleObject : FlyingSquirrelRace_ObstacleObject
{
	private enum Type
	{
		Type_0,
	...
	[Header("種類")]
	private Type type;
	private const float AnglerSpeed = 360f;
	[SerializeField]
	[DisplayName("移動速度")]
	...
	protected override void OnFixedUpdateMethod(float speed)
	{
		...
		renderer.transform.AddLocalEulerAnglesX(360f * Time.fixedDeltaTime * -1f);
	}
	private void Update()
	{

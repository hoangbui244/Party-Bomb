using GamepadInput;
using UnityEngine;
public class LegendarySword_ControllerManager : SingletonCustom<LegendarySword_ControllerManager>
{
	...
	public bool IsPushButton_A(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_A(_userType, _buttonPushType);
	}
	public bool IsPushButton_B(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_B(_userType, _buttonPushType);
	}
	public bool IsPushButton_X(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_X(_userType, _buttonPushType);
	}
	public bool IsPushButton_Y(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_Y(_userType, _buttonPushType);
	}
	public bool IsPushButton_L(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_L(_userType, _buttonPushType);
	}
	public bool IsPushButton_ZL(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_ZL(_userType, _buttonPushType);
	}
	public bool IsPushButton_R(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_R(_userType, _buttonPushType);
	}
	public bool IsPushButton_ZR(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_ZR(_userType, _buttonPushType);
	}
	public bool IsPushCrossKey(LegendarySword_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _buttonPushType)
	{
	...
	public bool IsStickTiltDirection(LegendarySword_Define.UserType _userType, StickType _stickType, StickDirType _stickDirType, float _stickNeutralValue = 0.5f)
	{
	...
	public bool IsPushButton_StickR(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickR(_userType, _buttonPushType);
	}
	public bool IsPushButton_StickL(LegendarySword_Define.UserType _userType, ButtonPushType _buttonPushType)
	{
		return ProcessPushButton_StickL(_userType, _buttonPushType);
	}
	public bool IsStickTilt(LegendarySword_Define.UserType _userType, StickType _stickType)
	{
		return GetStickTilt(_userType, _stickType) > 0.01f;
	}
	private bool ProcessPushButton_A(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_B(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_X(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_Y(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_L(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_ZL(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_R(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_ZR(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public Vector3 GetStickDir_R(LegendarySword_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
	...
	public Vector3 GetStickDir_L(LegendarySword_Define.UserType _userType)
	{
		float num = 0f;
		float num2 = 0f;
		Vector3 mVector3Zero = CalcManager.mVector3Zero;
	...
	private bool ProcessPushButton_StickR(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	private bool ProcessPushButton_StickL(LegendarySword_Define.UserType _userType, ButtonPushType _type)
	{
		int playerIdx = (int)((!SingletonCustom<JoyConManager>.Instance.IsSingleMode()) ? _userType : LegendarySword_Define.UserType.PLAYER_1);
		switch (_type)
		{
	...
	public float GetStickTilt(LegendarySword_Define.UserType _userType, StickType _stickType)
	{
	...
	private bool ProcessCrossKey(LegendarySword_Define.UserType _userType, CrossKeyType _keyType, ButtonPushType _type)
	{
	...
	private void ContinueInputHold_Stick_L(LegendarySword_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_Stick_R(LegendarySword_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0.2f;
	}
	private void ContinueInputHold_CrossKey(LegendarySword_Define.UserType _userType)
	{
		intervalInputHold_CrossKey[(int)_userType] = 0.2f;
	}
	private void ResetInputHold_Stick_L(LegendarySword_Define.UserType _userType)
	{
		intervalInputHold_LStick[(int)_userType] = 0f;
	}
	private void ResetInputHold_Stick_R(LegendarySword_Define.UserType _userType)
	{
		intervalInputHold_RStick[(int)_userType] = 0f;
	}
	private bool IsReturnInputHold_Stick_L(LegendarySword_Define.UserType _userType)
	{
		return intervalInputHold_LStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_Stick_R(LegendarySword_Define.UserType _userType)
	{
		return intervalInputHold_RStick[(int)_userType] <= 0f;
	}
	private bool IsReturnInputHold_CrossKey(LegendarySword_Define.UserType _userType)
	{

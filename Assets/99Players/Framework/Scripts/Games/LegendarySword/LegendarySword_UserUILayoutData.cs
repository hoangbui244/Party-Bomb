using UnityEngine;
public class LegendarySword_UserUILayoutData : MonoBehaviour
{
	[SerializeField]
	[Header("ゲ\u30fcム時間")]
	...
	[SerializeField]
	[Header("ユ\u30fcザ\u30fcUIのデ\u30fcタ")]
	private LegendarySword_UserUIData[] userUIDatas;
	[SerializeField]
	[Header("～組目の画像")]
	...
	public void SetUserUIData(LegendarySword_Define.UserType[] _userTypeArray)
	{
	...
	public void SetUserScore(LegendarySword_Define.UserType _userType, int _score)
	{
	}

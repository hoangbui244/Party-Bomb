...
using UnityEngine;
public class CharaLeanTweenMotion : MonoBehaviour {
    ...
    public void StartMotion(CharaLeanTweenMotionData.MotionData _motionData, Action callBack = null) {
    ...
    private IEnumerator MotionAnimation(CharaLeanTweenMotionData.MotionData _motionData, Action callBack = null) {
        if (_motionData.motionTime == 0f) {
            ...
            LeanTweenMotion(BodyPartsList.HEAD, _motionData.pose_HEAD.motionPingPong, _motionData.motionTime, _motionData.pose_HEAD.pose_Pos, _motionData.pose_HEAD.pose_Angle, _motionData.pose_HEAD.pose_Scale);
            LeanTweenMotion(BodyPartsList.BODY, _motionData.pose_BODY.motionPingPong, _motionData.motionTime, _motionData.pose_BODY.pose_Pos, _motionData.pose_BODY.pose_Angle, _motionData.pose_BODY.pose_Scale);
            LeanTweenMotion(BodyPartsList.HIP, _motionData.pose_HIP.motionPingPong, _motionData.motionTime, _motionData.pose_HIP.pose_Pos, _motionData.pose_HIP.pose_Angle, _motionData.pose_HIP.pose_Scale);
            LeanTweenMotion(BodyPartsList.SHOULDER_L, _motionData.pose_SHOULDER_L.motionPingPong, _motionData.motionTime, _motionData.pose_SHOULDER_L.pose_Pos, _motionData.pose_SHOULDER_L.pose_Angle, _motionData.pose_SHOULDER_L.pose_Scale);
            LeanTweenMotion(BodyPartsList.SHOULDER_R, _motionData.pose_SHOULDER_R.motionPingPong, _motionData.motionTime, _motionData.pose_SHOULDER_R.pose_Pos, _motionData.pose_SHOULDER_R.pose_Angle, _motionData.pose_SHOULDER_R.pose_Scale);
            LeanTweenMotion(BodyPartsList.ARM_L, _motionData.pose_ARM_L.motionPingPong, _motionData.motionTime, _motionData.pose_ARM_L.pose_Pos, _motionData.pose_ARM_L.pose_Angle, _motionData.pose_ARM_L.pose_Scale);
            LeanTweenMotion(BodyPartsList.ARM_R, _motionData.pose_ARM_R.motionPingPong, _motionData.motionTime, _motionData.pose_ARM_R.pose_Pos, _motionData.pose_ARM_R.pose_Angle, _motionData.pose_ARM_R.pose_Scale);
            LeanTweenMotion(BodyPartsList.LEG_L, _motionData.pose_LEG_L.motionPingPong, _motionData.motionTime, _motionData.pose_LEG_L.pose_Pos, _motionData.pose_LEG_L.pose_Angle, _motionData.pose_LEG_L.pose_Scale);
            LeanTweenMotion(BodyPartsList.LEG_R, _motionData.pose_LEG_R.motionPingPong, _motionData.motionTime, _motionData.pose_LEG_R.pose_Pos, _motionData.pose_LEG_R.pose_Angle, _motionData.pose_LEG_R.pose_Scale);
        }

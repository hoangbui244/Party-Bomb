...
namespace Flexalon
{
    ...
    public class FlexalonInteractable : MonoBehaviour
    {
        ...
        /// <summary> Collider to use to select this object. If not set, searches for a collider on this gameObject. </summary>
        public Collider Collider {
            get => _collider;
            set
            {
                _raycaster.Unregister(_collider);
                _collider = value;
                _raycaster.Register(_collider, this);
            }
        }
        ...
        void OnDisable()
        {
            ...
            {
                UpdateState(_inputProvider.InputMode, default, false, false);
            }
        ...
        void Update()
        {
            ...
            if (inputMode == InputMode.Raycast)
            {
                ...
                {
                    isHit = _raycaster.IsHit(ray, this);
                }
            }
            else
            {
            ...
            UpdateState(inputMode, ray, isHit, isActive);
        }
        ...
        private void UpdateState(InputMode inputMode, Ray ray, bool isHit, bool isActive)
        {
            if (_state == InteractableState.Init)
            {
                if (isHit)
        ...
        private bool CanAdd(FlexalonDragTarget currentDragTarget, FlexalonDragTarget dragTarget)
        {
            return dragTarget != null &&
                ...
                (dragTarget.CanAddObjects || currentDragTarget == dragTarget)  &&
